    ...
    return (
        ...
        < div className='mainControl' >
            ...
            <Container fluid="md">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', height: '50vh', backgroundColor: '#434c5f', width: '200', font: '20' }}>
                    ...
                    <Form>
                        ...
                        <Form.Row className="row-space">
                            ...
                            <Col xs="auto"> <Form.Control className="smaller-input" htmlSize="8" size="sm" type="text" placeholder="price number" /></Col>
                        </Form.Row>
                    </Form>
